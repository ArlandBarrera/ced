...
\begin{itemize}
  ...
  \item \textbf{Número de control}: el último dígito, se utiliza para verificar el PAN durante una transacción. También conocido como \textbf{Número de verificación}. Se obtiene utilizando el algoritmo de Luhn.
\end{itemize}
